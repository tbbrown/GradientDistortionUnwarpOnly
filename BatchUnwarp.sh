...
for subj in ${Subjects} ; do
    ...
    qsub -q hcp_standard.q -V subject_scripts/GradientDistortionUnwarpOnly.${subj}.sh --project=PipelineTest --subject=${subj} --outdir=/home/NRG/tbrown01/projects/Pipelines/GradientDistortionUnwarpOnly
done
